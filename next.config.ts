...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    FALLBACK_NEXT_PUBLIC_SUPABASE_URL: process.env.FALLBACK_NEXT_PUBLIC_SUPABASE_URL || "",
    FALLBACK_NEXT_PUBLIC_SUPABASE_ANON_KEY:
      process.env.FALLBACK_NEXT_PUBLIC_SUPABASE_ANON_KEY || "",
