-- Gate phone-digit matching in list_candidate_ids_page so email queries
-- (e.g. singh.ca.1237@gmail.com) do not match unrelated phones via embedded digits.
...
AS $$
  WITH search AS (
    SELECT
      ...
      CASE
        -- Mirror client isPhoneLikeSearchQuery: do not treat email/mixed strings as phone digits
        -- (e.g. singh.ca.1237@gmail.com -> 1237 falsely matching 512-373 phones).
