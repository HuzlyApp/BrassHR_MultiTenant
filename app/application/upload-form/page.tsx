        ...
        <div className="flex flex-1 flex-col gap-9">
          ...
          <div className="mt-auto grid grid-cols-2 gap-3 pt-8 sm:flex sm:items-center sm:justify-end sm:gap-4 sm:pt-10">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="inline-flex h-10 w-full cursor-pointer items-center justify-center rounded-xl px-4 text-[16px] font-semibold leading-6 text-white transition hover:brightness-90 sm:w-auto sm:px-6"
