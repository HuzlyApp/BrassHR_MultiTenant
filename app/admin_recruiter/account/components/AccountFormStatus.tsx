...
export function AccountSaveButton({
  ...
  return (
    <button
      ...
      className="inline-flex h-10 w-full items-center justify-center rounded-[6px] px-6 text-sm font-medium text-white transition disabled:opacity-60 min-[500px]:w-auto"
